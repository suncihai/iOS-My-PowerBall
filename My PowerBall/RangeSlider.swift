...
class RangeSlider: UIControl {
    ...
    @IBInspectable var minimumValue: Double = 30 {
        willSet(newValue) {
    ...
    @IBInspectable var maximumValue: Double = 300 {
        willSet(newValue) {
    ...
    @IBInspectable var lowerValue: Double = 90 {
        didSet {
    ...
    @IBInspectable var upperValue: Double = 240 {
        didSet {
